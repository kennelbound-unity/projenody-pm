...
public class ProjenodyCustomEditorWindow : EditorWindow
{
    ...
    ~ProjenodyCustomEditorWindow()
    {
        this.reorderableLists.Clear();
        this.reorderableLists = null;
    }

    public void ShowEditor(SerializedObject serializedObject)
    {
    ...
    protected ReorderableListProperty GetReorderableList(SerializedProperty property)
    {
                ...
                (idx) =>
                {
                    return
                        Mathf.Max(EditorGUIUtility.singleLineHeight,
                            EditorGUI.GetPropertyHeight(this._property.GetArrayElementAtIndex(idx), GUIContent.none,
                                true)) + 4.0f;
                };
        }
